...
app.use('/*', async (req, result)=> {
    const matchRoute = Routes.find( routes => matchPath(routes));
...
app.listen ('8080', () => {
    console.log('Express server has been started at http://localhost:8080/build');
});
