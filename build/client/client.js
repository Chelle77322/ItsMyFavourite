...
var store = (0, _toolkit.configureStore)(_index.rootReducer, _objectSpread({}, window.__APP_STATE), _actions.fetchFavourites);
console.info(_objectSpread({}, window.__APP_STATE));
